...
const MODEL_NAME = "gemini-1.5-flash"; // แก้ไขจาก 2.5 เป็น 1.5 ที่เสถียรกว่า
...
client.on(Events.InteractionCreate, async interaction => {
    ...
    // 1. ANALYZE PORTFOLIO ( optimized with Promise.all )
    ...
    // 3. ANALYZE DIVERSIFICATION ( optimized )
    ...
    // ... (ส่วน ask, stock, discover, sentiment, remove-stock, history ให้ใช้โค้ดเดิมของคุณได้เลยครับ)
    }
});
